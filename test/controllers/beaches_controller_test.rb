...
class BeachesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beach" do
    assert_difference("Beach.count") do
      post beaches_url, params: { beach: { address: @beach.address, latitude: @beach.latitude, longitude: @beach.longitude } }
    end
  ...
  test "should update beach" do
    patch beach_url(@beach), params: { beach: { address: @beach.address, latitude: @beach.latitude, longitude: @beach.longitude } }
